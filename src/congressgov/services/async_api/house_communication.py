...
from congressgov._client.api.house_communication import house_communication_detail_async
...
ASYNC_HOUSE_COMMUNICATION_MAPPINGS = {}

__all__ = ['AsyncHouseCommunication', 'ASYNC_HOUSE_COMMUNICATION_MAPPINGS']


class AsyncHouseCommunication(AsyncApiService):
