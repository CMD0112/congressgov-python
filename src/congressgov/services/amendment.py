...
AMENDMENT_MAPPINGS = {
    "actions": {amendment_actions_sync: ActionsModel},
    "amendments": {amendment_amendments_sync: AmendmentsModel},
    "cosponsors": {amendment_cosponsors_sync: CosponsorsModel},
    "textVersions": {amendment_text_sync: TextVersionsModel}
}
...
__all__ = ['Amendment', 'AMENDMENT_MAPPINGS', 'AMENDMENT_PARAMETERS']


class Amendment(ApiService):
    """
