...
T = TypeVar("T", bound="HouseVoteNumberBase")


@_attrs_define
class HouseVoteNumberBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        house_vote_number_base.additional_properties = d
        return house_vote_number_base
