...
T = TypeVar("T", bound="LegislativeSubjects")


@_attrs_define
class LegislativeSubjects:
    """
    Attributes:
        name (Union[Unset, str]):  Example: Congressional oversight.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        legislative_subjects = cls(
            name=name,
            update_date=update_date,
        )

        legislative_subjects.additional_properties = d
        return legislative_subjects
