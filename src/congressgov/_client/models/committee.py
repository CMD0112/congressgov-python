...
class Committee:
    ...
    Attributes:
        ...
        name (Union[Unset, str]):  Example: House Committee on the Judiciary.
        system_code (Union[Unset, str]):  Example: hsgo00.
        type_ (Union[Unset, str]):  Example: Standing.
        url (Union[Unset, str]):  Example: https://api.congress.gov/v3/committee/house/hsgo00?format=json.
    """
