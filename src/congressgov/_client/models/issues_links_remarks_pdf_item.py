...
T = TypeVar("T", bound="IssuesLinksRemarksPDFItem")


@_attrs_define
class IssuesLinksRemarksPDFItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        issues_links_remarks_pdf_item = cls(
            part=part,
            url=url,
        )

        issues_links_remarks_pdf_item.additional_properties = d
        return issues_links_remarks_pdf_item
