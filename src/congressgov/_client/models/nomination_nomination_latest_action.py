...
T = TypeVar("T", bound="NominationNominationLatestAction")


@_attrs_define
class NominationNominationLatestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2024-05-14.
        text (Union[Unset, str]):  Example: Confirmed by the Senate by Voice Vote..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nomination_nomination_latest_action = cls(
            action_date=action_date,
            text=text,
        )

        nomination_nomination_latest_action.additional_properties = d
        return nomination_nomination_latest_action
