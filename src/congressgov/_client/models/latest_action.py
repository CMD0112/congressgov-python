...
T = TypeVar("T", bound="LatestAction")
...
class LatestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2022-06-16.
        text (Union[Unset, str]):  Example: Read twice and referred to the Committee on the Judiciary..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        latest_action.additional_properties = d
