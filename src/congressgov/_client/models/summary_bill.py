...
class SummaryBill:
    ...
    Attributes:
        ...
        title (Union[Unset, str]):  Example: Pay Our Capitol Police Act.
        type_ (Union[Unset, str]):  Example: HR.
        update_date_including_text (Union[Unset, datetime.date]):  Example: 2021-08-08.
        url (Union[Unset, str]):  Example: https://api.congress.gov/v3/bill/117/hr/1234?format=json.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        summary_bill.additional_properties = d
        return summary_bill
