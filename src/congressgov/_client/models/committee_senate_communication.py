...
T = TypeVar("T", bound="CommitteeSenateCommunication")


@_attrs_define
class CommitteeSenateCommunication:
    """
    Attributes:
        ...
        url (Union[Unset, str]):  Example: https://api.congress.gov/v3/senate-communication/114/ec/7402?format=json.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        committee_senate_communication = cls(
        ...
        committee_senate_communication.additional_properties = d
        return committee_senate_communication
