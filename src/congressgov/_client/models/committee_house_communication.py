...
T = TypeVar("T", bound="CommitteeHouseCommunication")


@_attrs_define
class CommitteeHouseCommunication:
    """
    Attributes:
        ...
        url (Union[Unset, str]):  Example: https://api.congress.gov/v3/house-communication/114/ec/3262?format=json.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        committee_house_communication = cls(
        ...
        committee_house_communication.additional_properties = d
        return committee_house_communication
