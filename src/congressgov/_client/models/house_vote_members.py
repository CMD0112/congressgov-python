...
if TYPE_CHECKING:
    from ..models.house_vote_results import HouseVoteResults


T = TypeVar("T", bound="HouseVoteMembers")
...
class HouseVoteMembers:
    ...
    Attributes:
        ...
        results (Union[Unset, list['HouseVoteResults']]):
    ...
    results: Union[Unset, list["HouseVoteResults"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = HouseVoteResults.from_dict(results_item_data)

            results.append(results_item)

        vote_question = d.pop("voteQuestion", UNSET)

        house_vote_members = cls(
            congress=congress,
        ...
        house_vote_members.additional_properties = d
        return house_vote_members
