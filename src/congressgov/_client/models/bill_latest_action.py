...
T = TypeVar("T", bound="BillLatestAction")
...
class BillLatestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2025-11-21.
        text (Union[Unset, str]):  Example: Read twice and referred to the Committee on Agriculture, Nutrition, and
            Forestry..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bill_latest_action = cls(
            action_date=action_date,
            text=text,
        )

        bill_latest_action.additional_properties = d
        return bill_latest_action
