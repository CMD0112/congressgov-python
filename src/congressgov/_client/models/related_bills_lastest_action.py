...
T = TypeVar("T", bound="RelatedBillsLastestAction")


@_attrs_define
class RelatedBillsLastestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2019-01-01.
        text (Union[Unset, str]):  Example: On agreeing to the Maloney, Carolyn B. amendment (A002) Agreed to by voice
            vote. .
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        related_bills_lastest_action = cls(
            action_date=action_date,
            text=text,
        )

        related_bills_lastest_action.additional_properties = d
        return related_bills_lastest_action
