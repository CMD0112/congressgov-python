...
T = TypeVar("T", bound="LatestNominationAction")


@_attrs_define
class LatestNominationAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2022-12-07.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        latest_nomination_action = cls(
            action_date=action_date,
            text=text,
        )

        latest_nomination_action.additional_properties = d
        return latest_nomination_action
