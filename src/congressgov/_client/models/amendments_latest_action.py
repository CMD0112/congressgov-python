...
T = TypeVar("T", bound="AmendmentsLatestAction")


@_attrs_define
class AmendmentsLatestAction:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        amendments_latest_action = cls(
            action_date=action_date,
            text=text,
        )

        amendments_latest_action.additional_properties = d
        return amendments_latest_action
