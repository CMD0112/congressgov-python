...
T = TypeVar("T", bound="LawLatestAction")


@_attrs_define
class LawLatestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2025-11-21.
        text (Union[Unset, str]):  Example: Became Public Law No: 119-37..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        law_latest_action = cls(
            action_date=action_date,
            text=text,
        )

        law_latest_action.additional_properties = d
        return law_latest_action
