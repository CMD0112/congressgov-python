...
T = TypeVar("T", bound="SenateCommunicationTypeNumberCommitteesItem")


@_attrs_define
class SenateCommunicationTypeNumberCommitteesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        senate_communication_type_number_committees_item = cls(
            name=name,
            system_code=system_code,
            url=url,
        )

        senate_communication_type_number_committees_item.additional_properties = d
        return senate_communication_type_number_committees_item
