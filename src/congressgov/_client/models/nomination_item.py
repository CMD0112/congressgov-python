...
if TYPE_CHECKING:
    from ..models.latest_nomination_action import LatestNominationAction
    from ..models.nomination_type import NominationType


T = TypeVar("T", bound="NominationItem")
...
class NominationItem:
    """
    Attributes:
        citation (Union[Unset, str]):  Example: PN2804.
        congress (Union[Unset, int]):  Example: 117.
        description (Union[Unset, str]):  Example: Mary Anne Carter, of Tennessee, to be Chairperson of the National
            Endowment for the Arts for a term of four years, vice Maria Rosario Jackson, resigned..
        latest_action (Union[Unset, LatestNominationAction]):
        nomination_type (Union[Unset, NominationType]):
        number (Union[Unset, int]):  Example: 2804.
        organization (Union[Unset, str]):  Example: Army.
        part_number (Union[Unset, str]):  Example: 00.
        received_date (Union[Unset, datetime.date]):  Example: 2022-12-07.
        update_date (Union[Unset, datetime.datetime]):  Example: 2022-12-08T05:25:17Z.
        url (Union[Unset, str]):  Example: https://api.congress.gov/v3/nomination/117/2804?format=json.
    """

    citation: Union[Unset, str] = UNSET
    congress: Union[Unset, int] = UNSET
    description: Union[Unset, str] = UNSET
    latest_action: Union[Unset, "LatestNominationAction"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_latest_action, Unset):
            ...
            latest_action = LatestNominationAction.from_dict(_latest_action)
        ...
        nomination_item.additional_properties = d
        return nomination_item
