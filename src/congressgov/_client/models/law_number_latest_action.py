...
T = TypeVar("T", bound="LawNumberLatestAction")


@_attrs_define
class LawNumberLatestAction:
    """
    Attributes:
        action_date (Union[Unset, datetime.date]):  Example: 2025-01-06.
        text (Union[Unset, str]):  Example: Became Public Law No: 118-274..
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        law_number_latest_action = cls(
            action_date=action_date,
            text=text,
        )

        law_number_latest_action.additional_properties = d
        return law_number_latest_action
