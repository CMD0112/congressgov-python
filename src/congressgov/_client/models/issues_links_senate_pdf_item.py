...
T = TypeVar("T", bound="IssuesLinksSenatePDFItem")


@_attrs_define
class IssuesLinksSenatePDFItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        issues_links_senate_pdf_item = cls(
            part=part,
            url=url,
        )

        issues_links_senate_pdf_item.additional_properties = d
        return issues_links_senate_pdf_item
