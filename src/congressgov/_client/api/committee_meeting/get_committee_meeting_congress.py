...
from ...models.get_committee_meeting_congress_format import GetCommitteeMeetingCongressFormat
...
def _get_kwargs(
    congress: int,
    *,
    format_: Union[Unset, GetCommitteeMeetingCongressFormat] = GetCommitteeMeetingCongressFormat.XML,
    ...
    if format_ is None:
        format_ = GetCommitteeMeetingCongressFormat.JSON
    elif isinstance(format_, str):
        format_ = GetCommitteeMeetingCongressFormat(format_.lower())
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/committee-meeting/{congress}".format(
            congress=congress,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        congress (int):
        format_ (Union[Unset, GetCommitteeMeetingCongressFormat]):  Default:
            GetCommitteeMeetingCongressFormat.XML.
