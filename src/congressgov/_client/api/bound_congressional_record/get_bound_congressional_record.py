...
from ...models.get_bound_congressional_record_format import GetBoundCongressionalRecordFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetBoundCongressionalRecordFormat] = GetBoundCongressionalRecordFormat.XML,
    ...
    if format_ is None:
        format_ = GetBoundCongressionalRecordFormat.JSON
    elif isinstance(format_, str):
        format_ = GetBoundCongressionalRecordFormat(format_.lower())
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetBoundCongressionalRecordFormat]):  Default:
            GetBoundCongressionalRecordFormat.XML.
