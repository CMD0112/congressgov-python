...
def _get_kwargs(
    ...
    *,
    ...
    if format_ is None:
        format_ = GetAmendmentCongressAmendmentTypeAmendmentNumberActionsFormat.JSON
    elif isinstance(format_, str):
        format_ = GetAmendmentCongressAmendmentTypeAmendmentNumberActionsFormat(format_.lower())
