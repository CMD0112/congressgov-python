...
from ...models.get_amendment_congress_format import GetAmendmentCongressFormat
...
def _get_kwargs(
    congress: int,
    *,
    format_: Union[Unset, GetAmendmentCongressFormat] = GetAmendmentCongressFormat.XML,
    ...
    if format_ is None:
        format_ = GetAmendmentCongressFormat.JSON
    elif isinstance(format_, str):
        format_ = GetAmendmentCongressFormat(format_.lower())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        congress (int):
        format_ (Union[Unset, GetAmendmentCongressFormat]):  Default:
            GetAmendmentCongressFormat.XML.
