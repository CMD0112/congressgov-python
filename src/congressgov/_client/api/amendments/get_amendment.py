...
from ...models.get_amendment_format import GetAmendmentFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetAmendmentFormat] = GetAmendmentFormat.XML,
    ...
    if format_ is None:
        format_ = GetAmendmentFormat.JSON
    elif isinstance(format_, str):
        format_ = GetAmendmentFormat(format_.lower())
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetAmendmentFormat]):  Default: GetAmendmentFormat.XML.
