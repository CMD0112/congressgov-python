...
from ...models.get_summaries_congress_format import GetSummariesCongressFormat
...
def _get_kwargs(
    congress: int,
    *,
    format_: Union[Unset, GetSummariesCongressFormat] = GetSummariesCongressFormat.XML,
    ...
    if format_ is None:
        format_ = GetSummariesCongressFormat.JSON
    elif isinstance(format_, str):
        format_ = GetSummariesCongressFormat(format_.lower())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        congress (int):
        format_ (Union[Unset, GetSummariesCongressFormat]):  Default:
            GetSummariesCongressFormat.XML.
