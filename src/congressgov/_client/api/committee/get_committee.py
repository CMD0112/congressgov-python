...
from ...models.get_committee_format import GetCommitteeFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetCommitteeFormat] = GetCommitteeFormat.XML,
    ...
    if format_ is None:
        format_ = GetCommitteeFormat.JSON
    elif isinstance(format_, str):
        format_ = GetCommitteeFormat(format_.lower())
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetCommitteeFormat]):  Default: GetCommitteeFormat.XML.
