...
from ...models.get_committee_congress_format import GetCommitteeCongressFormat
...
def _get_kwargs(
    congress: int,
    *,
    format_: Union[Unset, GetCommitteeCongressFormat] = GetCommitteeCongressFormat.XML,
    ...
    if format_ is None:
        format_ = GetCommitteeCongressFormat.JSON
    elif isinstance(format_, str):
        format_ = GetCommitteeCongressFormat(format_.lower())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        congress (int):
        format_ (Union[Unset, GetCommitteeCongressFormat]):  Default:
            GetCommitteeCongressFormat.XML.
