...
from ...models.get_committee_print_format import GetCommitteePrintFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetCommitteePrintFormat] = GetCommitteePrintFormat.XML,
    ...
    if format_ is None:
        format_ = GetCommitteePrintFormat.JSON
    elif isinstance(format_, str):
        format_ = GetCommitteePrintFormat(format_.lower())
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetCommitteePrintFormat]):  Default: GetCommitteePrintFormat.XML.
