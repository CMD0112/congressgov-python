...
from ...models.get_congress_current_format import GetCongressCurrentFormat
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    format_: Union[Unset, GetCongressCurrentFormat] = GetCongressCurrentFormat.XML,
    ...
    if format_ is None:
        format_ = GetCongressCurrentFormat.JSON
    elif isinstance(format_, str):
        format_ = GetCongressCurrentFormat(format_.lower())
...
def sync_detailed(
    *,
    ...
    Args:
        format_ (Union[Unset, GetCongressCurrentFormat]):  Default: GetCongressCurrentFormat.XML.
